...
def test_frontend_admin_entry_requires_platform_permission_and_confirms_risky_changes():
    view = (ROOT / "frontend/src/views/settings/CustomerModulesView.vue").read_text(encoding="utf-8")
    api = (ROOT / "frontend/src/api/moduleAssets.js").read_text(encoding="utf-8")
