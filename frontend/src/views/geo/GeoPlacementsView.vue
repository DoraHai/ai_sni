...
<template>
  ...
  >
    <template #actions>
      ...
      <router-link class="gd-btn" to="/geo/channels">渠道库</router-link>
    ...
    <div class="geo-dash">
      ...
      <div class="gd-bottom">
        <div class="gd-card">
          <div class="gd-hd">
            <h3>发布计划</h3>
            <router-link class="more" to="/geo/articles">匹配 GEO 文章 →</router-link>
          </div>
          <div class="gd-bd">
            <ul v-if="publishPlan.length" class="gd-sources">
              <li v-for="t in publishPlan" :key="t.id">
                ...
                <router-link class="plan-link" :to="`/geo/articles/${t.id}`">{{ t.title }}</router-link>
        ...
        <div class="gd-card">
          ...
          <div class="gd-bd">
            ...
            <router-link class="more-foot" to="/geo/sources">去信源分析 →</router-link>
          </div>
        </div>
      </div>
