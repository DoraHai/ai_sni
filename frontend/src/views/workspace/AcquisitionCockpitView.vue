...
<template>
  <main class="cockpit-shell" v-loading="loading">
    <header class="command-bar">
      <div><p>G-SNIPERS ACQUISITION DESK</p><h1>G-Snipers 获客工作台</h1><span>获客推广AI智能体</span></div>
