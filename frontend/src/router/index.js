...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'structure', component: () => import('../views/geo/GeoStructureView.vue'), meta: { title: '官网结构优化', documentTitle: 'GEO 工作台｜官网结构优化' } },
      { path: 'import', component: () => import('../views/geo/GeoArticleImportView.vue'), meta: { title: '导入已有文章', documentTitle: 'GEO 工作台｜导入已有文章' } },
      { path: 'tickets', component: () => import('../views/geo/GeoTicketsView.vue'), meta: { title: '验收工单', documentTitle: 'GEO 工作台｜验收工单' } },
      { path: 'evaluation', component: () => import('../views/geo/GeoEvaluationView.vue'), meta: { title: '评价分析', documentTitle: 'GEO 工作台｜评价分析' } },
