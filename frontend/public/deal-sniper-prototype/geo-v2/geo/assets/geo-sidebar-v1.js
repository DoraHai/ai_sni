(function () {
  ...
  sidebar.innerHTML =
    ...
    item('structure.html', '⌗', '官网结构优化') +
    '<div class="nav-group">设置</div>' +
    item('brand.html', '▰', '品牌信息') +
    item('knowledge.html', '▣', '知识库') +
