...
assert.match(keywordWorkbench, /writebackMode\?\.mode === 'limited_live'/)
assert.match(keywordWorkbench, /writebackMode\.live_scopes\?\.includes\('keyword_bid'\)/)
assert.match(keywordWorkbench, /确认并真实执行/)
assert.match(keywordWorkbench, /\{\{ keywordWritebackButtonLabel \}\}/)
