(function () {
  ...
  sidebar.innerHTML =
    ...
    '<a class="nav-item" href="/deal-sniper/geo/dashboard.html#/geo/overview" target="_top"><span class="ico">G</span> GEO 工作台</a>' +
    '<a class="back-link" href="../hub/dashboard.html">⌂ 全域驾驶舱</a>' +
    '<a class="back-link" style="border-top:none;padding-top:0;" href="https://sem.snipers.com.cn/deal-sniper/portal" target="_top">← 平台门户</a>';
})();
