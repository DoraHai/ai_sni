...
client.defaults.adapter=async config=>{
 ...
 let data
 if(method==='post' && path.endsWith('/tasks')) data={...JSON.parse(config.data),id:11,status:'open'}
 else if(method==='get' && path.endsWith('/tasks')) data=config.params.tenant_id===7?[task]:[]
