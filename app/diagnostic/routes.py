...
from app.diagnostic.ai_client import DeepSeekError, is_enabled as ai_enabled
from app.config import get_settings
from app.database import get_session
from app.diagnostic.ai_sampling import (
    build_neutral_questions,
    clean_questions,
    run_deepseek_sample,
)
from app.diagnostic.audit import RULE_VERSION, RULE_WEIGHTS, GeoAuditError, audit_url
from app.diagnostic.brand_profile import discover_brand_profile, website_key
from app.diagnostic.chinaz import fetch_chinaz_seo_metrics
from app.diagnostic.generate import ai_advice, generate_json_ld, generate_llms_text
from app.diagnostic.pagespeed import fetch_pagespeed_insights
from app.diagnostic.site_audit import audit_site
from app.models import GeoAuditRun, Tenant
from app.models.tenant_memory import TenantMemory
from app.security.auth import AuthContext
from app.diagnostic.auth import require_diagnostic_auth as require_scoped_auth
