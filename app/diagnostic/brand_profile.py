...
from app.diagnostic.audit import PageDocument, normalize_url, safe_fetch
...
async def discover_brand_profile(website: str) -> dict[str, Any]:
    from app.diagnostic.ai_client import DeepSeekError, chat_json, is_enabled as ai_enabled
