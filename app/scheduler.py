...
# GEO 定时任务已迁到 app.geo.content.geo_scheduler，主站与 geo_main 共用跨进程锁。
from app.geo.content.geo_scheduler import (  # noqa: E402
...
def start_scheduler() -> None:
    from app.geo.content.geo_scheduler import start_geo_scheduler

    # GEO 有独立跨进程锁，SEM 锁抢不到时仍要尝试挂巡检。
    start_geo_scheduler()
...
def shutdown_scheduler() -> None:
    from app.geo.content.geo_scheduler import shutdown_geo_scheduler
