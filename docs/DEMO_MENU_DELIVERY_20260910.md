...
- 前端 production-sem 最终=`f3be70f855221245379af6324070b95f31f53407`（CI/前端 run `34593573264` 成功）。统一客户管理页已包含“执行权限”、账户选择、动作范围、额度、确认提示、历史和暂停入口；`/platform/*` 路由部署 run `34593573212` 于交接时仍在执行，完成后即暂停开发。
